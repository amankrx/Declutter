//! # Declutter
//!
//! Welcome to Declutter's docs! Declutter is a Habit Tracker for GNOME. It's goal is to help you
//! declutter your life by tracking your habits and helping you to form new ones.
//!
//! This documentation should help you get started with Declutter's structs and functions. To make
//! the start a bit easier, let me explain some basics about Declutter's architecture:
//!
//! * Declutter's source is split into multiple directories to make working with the many source files a bit easier:
//!     * [core](crate::core): This directory contains core modules of Declutter that are used throughout the application, like the
